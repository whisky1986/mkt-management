...
[▶ 260707_daily-report.html 브라우저로 열기](260707_daily-report.html)

<iframe src="260707_daily-report.html" width="100%" height="900" style="border:1px solid #2a2f3a;border-radius:10px;"></iframe>
...
- 지원시작 **5,151** → 지원완료 **1,430** (완료율 27.76%) → 교육시작 **476** (교육시작전환 33.29%)
- 집행비용 **11.3억** · 예상매출 **63.1억** · 목표매출 195.0억 · 매출달성율 32.37% · **ROAS(전체) 556.47%**
...
## 📊 전일 대비 경향성 · 직전 260706 대비 (비판적 분석)

| 캠프 | 지원시작 | 지원완료 | 완료전환율 | 내배카 | 목표달성율 | 심사진행(합/불/예비) |
|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | ▲2 | ±0 | ▼1.4pp | ▼10.1pp | ±0pp | 합+0 불+0 예+0 |
| 클라우드 8기 | ▲5 | ▲1 | ▼0.6pp | ▼1.0pp | ▲1.7pp | 합+4 불+2 예+0 |
| 그로스 마케팅 6기 | ▲13 | ▲4 | ▲0.1pp | ▼0.3pp | ▲2.8pp | 합+4 불+10 예-5 |

*Δ = 오늘 − 직전 리포트 · 1일 변동이라 노이즈 가능성 유의*

**백엔드 자바 27기**

1. 신규 지원 +2명인데 완료전환율 -1.4pp 하락 — 유입은 늘었으나 완료로 이어지지 않음. '숫자 증가'에 안심 말고 유입 채널 품질·지원서 이탈 지점을 의심해야 함.
2. 내배카 보유율 -10.1pp 변동 — 신규 유입의 연령·신분 세그먼트가 이동했을 가능성. 연령대×합불상태/내배카 교차표로 어느 층이 늘었는지 확인.

**클라우드 8기**

1. 신규 지원 +5명인데 완료전환율 -0.6pp 하락 — 유입은 늘었으나 완료로 이어지지 않음. '숫자 증가'에 안심 말고 유입 채널 품질·지원서 이탈 지점을 의심해야 함.
2. 심사 진행 6건(합격 +4·불합격 +2·예비 +0) vs 지원완료 +1 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 달성율 53.3→55.0% (+1.7pp) — 오늘 +1명 페이스면 잔여 27명에 약 27일. 잔여 모집기간과 대조해 '달성 가능 페이스'인지 판단.

**그로스 마케팅 6기**

1. 지원 +13명 · 전환율 +0.1pp 동반 — 양·질 함께 개선. 단, 1일 변동이라 추세 확정 전 2~3일 더 관찰 필요.
2. 심사 진행 9건(합격 +4·불합격 +10·예비 -5) vs 지원완료 +4 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 달성율 77.5→80.3% (+2.8pp) — 오늘 +4명 페이스면 잔여 28명에 약 7일. 잔여 모집기간과 대조해 '달성 가능 페이스'인지 판단.
...
2. 완료전환 16.0% vs 미완료 84% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 대학(원)생 내배카 보유율 33.3%(n=3) — 비용 민감 세그먼트. 이 그룹이 완료전환에서 더 이탈하는지 교차 점검하고 자비·국비 메시지 분기 검토.

**클라우드 8기** (목표 60 · 달성율 55.0%)

1. 목표 달성율 55.0%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 2.1명 기준 잔여 27명은 약 13일 소요. 마감 D-20 대비 여유.
2. 완료전환 32.7% vs 미완료 66% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 대학(원)생 내배카 보유율 22.2%(n=9) — 비용 민감 세그먼트. 이 그룹이 완료전환에서 더 이탈하는지 교차 점검하고 자비·국비 메시지 분기 검토.

**그로스 마케팅 6기** (목표 142 · 달성율 80.3%)

1. 목표 달성율 80.3%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 5.3명 기준 잔여 28명은 약 5일 소요. 마감 D-12 대비 여유.
2. 완료전환 28.7% vs 미완료 70% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
...
|---|---|---|---|---|---|---|---|
| ~19 | 0 | 4 | 0 | 0 | 0 | 0 | 4 |
| 20-24 | 1 | 23 | 1 | 3 | 2 | 1 | 31 |
| 25-29 | 0 | 25 | 4 | 10 | 1 | 3 | 43 |
| 30-34 | 1 | 8 | 1 | 4 | 1 | 0 | 15 |
| 35-39 | 0 | 2 | 0 | 0 | 0 | 0 | 2 |
| 40+ | 0 | 5 | 3 | 0 | 1 | 0 | 9 |
...
|---|---|---|---|---|---|---|---|
| ~19 | 0 | 8 | 0 | 0 | 1 | 0 | 9 |
| 20-24 | 11 | 128 | 2 | 15 | 18 | 7 | 181 |
| 25-29 | 7 | 98 | 0 | 19 | 18 | 4 | 146 |
| 30-34 | 2 | 34 | 1 | 2 | 14 | 0 | 53 |
| 35-39 | 0 | 4 | 0 | 1 | 0 | 0 | 5 |
| 40+ | 1 | 6 | 0 | 0 | 2 | 0 | 9 |

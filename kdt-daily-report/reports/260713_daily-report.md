...
# 📊 KDT 모객현황 데일리 리포트 · 2026-07-13

> [!info] 대상 캠프 3종 · 내부직원·테스트 제외 · **TEST 출력본**

## 🔗 리포트 열기 (인터랙티브)

[▶ 260713_daily-report.html 브라우저로 열기](260713_daily-report.html)

<iframe src="260713_daily-report.html" width="100%" height="900" style="border:1px solid #2a2f3a;border-radius:10px;"></iframe>
...
|---|---|---|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | 70 | 35 | 49 | 35 | 13 | 26.5% | 18.6% | 1.4:1 | 54.2% |
| 클라우드 8기 | 60 | 30 | 145 | 98 | 44 | 30.3% | 73.3% | 4.8:1 | 52.9% |
| 그로스 마케팅 6기 | 142 | 57 | 497 | 346 | 145 | 29.2% | 102.1% | 8.7:1 | 58.0% |

- **총 지원시작** 691 · **완료** 202 (평균 전환 29.2%) · **미완료 적체** 479 (69%)
- **내배카 보유율** 56.6% (유효응답 325명)

## 📅 KDT 2026 연간 누적 (모객 현황표 전체)

- 지원시작 **5,319** → 지원완료 **1,481** (완료율 27.84%) → 교육시작 **481** (교육시작전환 32.48%)
- 집행비용 **11.7억** · 예상매출 **63.7억** · 목표매출 195.0억 · 매출달성율 32.66% · **ROAS(전체) 542.48%**

## 📅 모집 마감 전망 (트렌드 × 종결일)

| 캠프 | 모집기간 | 마감 | 경과 | 완료/목표 | 페이스(명/일) | 예상도달(목표대비) | 전망 |
|---|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | 2026-07-01~2026-08-03 | D-21 | 38% | 13/70 | 1.29 | 40 (57%) | 마감 내 목표 미달 전망 |
| 클라우드 8기 | 2026-06-23~2026-07-27 | D-14 | 60% | 44/60 | 1.71 | 68 (113%) | 마감 내 목표 달성 전망 |
| 그로스 마케팅 6기 | 2026-06-16~2026-07-19 | D-6 | 82% | 145/142 | 5.0 | 175 (123%) | 목표 조기 달성 |

- **백엔드 자바 27기**: 최근 1.29명/일 → 마감 예상 40명(목표 70 대비 57%) → **마감 내 목표 미달 전망**.
- **클라우드 8기**: 최근 1.71명/일 → 마감 예상 68명(목표 60 대비 113%) → **마감 내 목표 달성 전망**.
- **그로스 마케팅 6기**: 목표 모객(142명) 초과 달성 · 마감 D-6 — 선발·등록 전환·정원 적합도로 전환.

## 🔻 전환 퍼널 & 기수 벤치마크 (모객 현황표 연동)

| 캠프 | 조회수 | 지원시작 | 지원완료 | 고용24등록 | 교육시작 | 완료율 | 교육시작전환 | 정원달성율 |
|---|---|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | 12403 | 49 | 13 | 0 | 0 | 26.5% | 0.0% | 0.0% |
| 클라우드 8기 | 26070 | 145 | 44 | 6 | 4 | 30.3% | 9.1% | 13.3% |
| 그로스 마케팅 6기 | 51098 | 497 | 145 | 27 | 19 | 29.2% | 13.1% | 33.3% |
...
| 클라우드 8기 | 교육시작 4/정원 30 | 모객중(현재 13.3%, 종료후 확정) | 9.1% (모객중·참고용) |
| 그로스 마케팅 6기 | 교육시작 19/정원 57 | 모객중(현재 33.3%, 종료후 확정) | 13.1% (모객중·참고용) |

**기수 벤치마크**

- **백엔드 자바 27기** vs 백엔드자바 5개기수 평균 — 완료율 26.5% vs 31.1% (-4.6pp) · 교육시작전환 0.0% vs 33.2% (-33.2pp) · 정원달성 0.0% vs 79.1% (-79.1pp)
- **클라우드 8기** vs 클라우드 3개기수 평균 — 완료율 30.3% vs 26.1% (+4.2pp) · 교육시작전환 9.1% vs 30.5% (-21.4pp) · 정원달성 13.3% vs 85.8% (-72.5pp)
- **그로스 마케팅 6기** vs 그로스마케팅 2개기수 평균 — 완료율 29.2% vs 24.5% (+4.7pp) · 교육시작전환 13.1% vs 43.0% (-29.9pp) · 정원달성 33.3% vs 101.3% (-68.0pp)

> 지원완료(모객)는 중간 지표 — CDC KPI는 **정원 대비 교육시작**·**지원완료→교육시작 전환**. 모객중 기수는 교육시작이 종료 후 확정되므로 진행중 표기.

## 💰 캠프별 단위경제 (모객 현황표 · 비용/매출)

| 캠프 | 집행예산 | 예산소진율 | CPA(완료당) | CAC(획득당) | 기대매출 | ROAS |
|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | 1753만 | 18% | 36만 | 135만 | ₩0 | 0% |
| 클라우드 8기 | 4387만 | 44% | 30만 | 100만 | 5808만 | 132% |
| 그로스 마케팅 6기 | 6712만 | 84% | 14만 | 46만 | 2.1억 | 312% |

## 🧑‍⚖️ 선발(심사) 현황 (합불상태 · ITLAB 선발 → 전환 영향)

| 캠프 | 제출완료 | 검토전(적체) | 예비합격 | 합격 | 불합격 | 합격률 | 불합격률 |
|---|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | 13 | 5 | 0 | 8 | 0 | 100.0% | 0.0% |
| 클라우드 8기 | 44 | 5 | 14 | 20 | 5 | 80.0% | 20.0% |
| 그로스 마케팅 6기 | 145 | 18 | 9 | 52 | 66 | 44.1% | 55.9% |

> 합격률=합격/(합격+불합격). **불합격률↑ = 지원자 퀄리티 관리 시그널.** 검토전=심사 적체(선발 대기). 대상아님=지원중(작성단계), 지원취소=이탈.

## 📊 전일 대비 경향성 · 직전 260707 대비 (비판적 분석)

| 캠프 | 지원시작 | 지원완료 | 완료전환율 | 내배카 | 목표달성율 | 심사진행(합/불/예비) |
|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | ▲24 | ▲9 | ▲10.5pp | ▲8.7pp | ▲12.9pp | 합+8 불+0 예+0 |
| 클라우드 8기 | ▲44 | ▲11 | ▼2.4pp | ▼0.8pp | ▲18.3pp | 합+3 불+0 예+5 |
| 그로스 마케팅 6기 | ▲100 | ▲31 | ▲0.5pp | ▼3.3pp | ▲21.8pp | 합+15 불+13 예+6 |

*Δ = 오늘 − 직전 리포트 · 1일 변동이라 노이즈 가능성 유의*

**백엔드 자바 27기**

1. 지원 +24명 · 전환율 +10.5pp 동반 — 양·질 함께 개선. 단, 1일 변동이라 추세 확정 전 2~3일 더 관찰 필요.
2. 심사 진행 8건(합격 +8·불합격 +0·예비 +0) vs 지원완료 +9 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 달성율 5.7→18.6% (+12.9pp) — 오늘 +9명 페이스면 잔여 57명에 약 6일. 잔여 모집기간과 대조해 '달성 가능 페이스'인지 판단.
4. 내배카 보유율 +8.7pp 변동 — 신규 유입의 연령·신분 세그먼트가 이동했을 가능성. 연령대×합불상태/내배카 교차표로 어느 층이 늘었는지 확인.

**클라우드 8기**

1. 신규 지원 +44명인데 완료전환율 -2.4pp 하락 — 유입은 늘었으나 완료로 이어지지 않음. '숫자 증가'에 안심 말고 유입 채널 품질·지원서 이탈 지점을 의심해야 함.
2. 심사 진행 8건(합격 +3·불합격 +0·예비 +5) vs 지원완료 +11 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 달성율 55.0→73.3% (+18.3pp) — 오늘 +11명 페이스면 잔여 16명에 약 1일. 잔여 모집기간과 대조해 '달성 가능 페이스'인지 판단.

**그로스 마케팅 6기**

1. 지원 +100명 · 전환율 +0.5pp 동반 — 양·질 함께 개선. 단, 1일 변동이라 추세 확정 전 2~3일 더 관찰 필요.
2. 심사 진행 34건(합격 +15·불합격 +13·예비 +6) vs 지원완료 +31 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 도달 유지(달성율 102.1%) — 점검 축을 완료 수 → 등록 전환·적합도로 이동.
4. 내배카 보유율 -3.3pp 변동 — 신규 유입의 연령·신분 세그먼트가 이동했을 가능성. 연령대×합불상태/내배카 교차표로 어느 층이 늘었는지 확인.

## 🧐 부트캠프별 점검 코멘트 (비판적 점검 포인트)

**백엔드 자바 27기** (목표 70 · 달성율 18.6%)

1. 목표 달성율 18.6%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 1.4명 기준 잔여 57명은 약 41일 소요. 마감 D-21 내 달성 불가 페이스 — 강한 가속/연장 검토.
2. 완료전환 26.5% vs 미완료 71% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 최근 3일 신규 지원 급감(일평균 4→2명) — 매체 예산 소진·타깃 피로 가능성. 채널별 잔여 예산·CPA를 우선 점검.

**클라우드 8기** (목표 60 · 달성율 73.3%)

1. 목표 달성율 73.3%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 1.7명 기준 잔여 16명은 약 9일 소요. 마감 D-14 대비 여유.
2. 완료전환 30.3% vs 미완료 68% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 대학(원)생 내배카 보유율 28.6%(n=14) — 비용 민감 세그먼트. 이 그룹이 완료전환에서 더 이탈하는지 교차 점검하고 자비·국비 메시지 분기 검토.

**그로스 마케팅 6기** (목표 142 · 달성율 102.1%)

1. 목표 142명 도달(달성율 102.1%) — 점검 지표를 완료 '수'에서 질(적합도·등록 전환·미수료 리스크)로 전환할 시점.
2. 완료전환 29.2% vs 미완료 70% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 최근 3일 신규 지원 급감(일평균 18→9명) — 매체 예산 소진·타깃 피로 가능성. 채널별 잔여 예산·CPA를 우선 점검.
...
| 신분 | YES | NO | 합계 | YES 비율 |
|---|---|---|---|---|
| 대학(원)생 | 17 | 29 | 46 | 37.0% |
| 취업준비생 | 93 | 47 | 140 | 66.4% |
| 직장인/프리랜서 | 12 | 8 | 20 | 60.0% |
| 기타 | 9 | 9 | 18 | 50.0% |
| 알 수 없음 | 3 | 4 | 7 | 42.9% |
...
|---|---|---|---|---|---|---|---|
| ~19 | 1 | 5 | 0 | 0 | 0 | 0 | 6 |
| 20-24 | 0 | 36 | 2 | 3 | 2 | 2 | 45 |
| 25-29 | 1 | 32 | 6 | 10 | 1 | 10 | 60 |
| 30-34 | 3 | 13 | 2 | 7 | 1 | 0 | 26 |
| 35-39 | 0 | 2 | 1 | 0 | 0 | 0 | 3 |
| 40+ | 0 | 10 | 3 | 0 | 1 | 0 | 14 |
...
|---|---|---|---|---|---|---|---|
| ~19 | 0 | 12 | 0 | 0 | 1 | 0 | 13 |
| 20-24 | 5 | 162 | 4 | 22 | 26 | 7 | 226 |
| 25-29 | 8 | 120 | 3 | 26 | 22 | 5 | 184 |
| 30-34 | 5 | 41 | 1 | 3 | 15 | 0 | 65 |
| 35-39 | 0 | 4 | 0 | 1 | 0 | 0 | 5 |
| 40+ | 0 | 6 | 1 | 0 | 2 | 0 | 9 |
...
|---|---|---|---|---|---|---|---|
| 백엔드 자바 27기 | 26.0 | 26.6 | 23.0 | 27.25 | 19.0 | 54.0 | 40 |
| 클라우드 8기 | 26.0 | 28.1 | 23.0 | 30.0 | 15.0 | 76.0 | 103 |
| 그로스 마케팅 6기 | 25.0 | 25.6 | 23.0 | 28.0 | 15.0 | 60.0 | 363 |
...
---
*생성 2026-07-13 10:15 · 내배카 비율은 yes/no 유효응답(지원완료·지원중) 기준 · 상태1 공란은 '알 수 없음' 처리*

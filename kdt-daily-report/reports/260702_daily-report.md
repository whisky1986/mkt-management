...
# 📊 KDT 모객현황 데일리 리포트 · 2026-07-02

> [!info] 대상 캠프 4종 · 내부직원·테스트 제외 · **TEST 출력본**

## 🔗 리포트 열기 (인터랙티브)

[▶ 260702_daily-report.html 브라우저로 열기](260702_daily-report.html)

<iframe src="260702_daily-report.html" width="100%" height="900" style="border:1px solid #2a2f3a;border-radius:10px;"></iframe>
...
| 백엔드 자바 27기 | 70 | 35 | 4 | 3 | 1 | 25.0% | 1.4% | 0.1:1 | 100.0% |
| 클라우드 8기 | 60 | 30 | 73 | 47 | 25 | 34.2% | 41.7% | 2.4:1 | 64.3% |
| 그로스 마케팅 6기 | 142 | 57 | 323 | 232 | 89 | 27.6% | 62.7% | 5.7:1 | 63.1% |

- **총 지원시작** 685 · **완료** 214 (평균 전환 31.2%) · **미완료 적체** 462 (67%)
- **내배카 보유율** 60.6% (유효응답 330명)

## 📅 KDT 2026 연간 누적 (모객 현황표 전체)

- 지원시작 **5,028** → 지원완료 **1,394** (완료율 27.72%) → 교육시작 **465** (교육시작전환 33.36%)
- 집행비용 **11.0억** · 예상매출 **61.8억** · 목표매출 195.0억 · 매출달성율 31.68% · **ROAS(전체) 559.67%**

## 📅 모집 마감 전망 (트렌드 × 종결일)

| 캠프 | 모집기간 | 마감 | 경과 | 완료/목표 | 페이스(명/일) | 예상도달(목표대비) | 전망 |
|---|---|---|---|---|---|---|---|
| 백엔드 자바 26기 | 2026-05-27~2026-06-29 | D-0 | 100% | 99/72 | 2.14 | 99 (138%) | 목표 조기 달성 |
| 백엔드 자바 27기 | 2026-07-01~2026-08-03 | D-32 | 6% | 1/70 | 0.5 | 17 (24%) ⚠️초기 | 마감 내 목표 미달 전망 |
| 클라우드 8기 | 2026-06-23~2026-07-27 | D-25 | 29% | 25/60 | 2.71 | 93 (155%) | 마감 내 목표 달성 전망 |
| 그로스 마케팅 6기 | 2026-06-16~2026-07-19 | D-17 | 50% | 89/142 | 4.29 | 162 (114%) | 마감 내 목표 달성 전망 |

- **백엔드 자바 26기**: 목표 모객(72명) 초과 달성 · 마감 D-0 — 선발·등록 전환·정원 적합도로 전환.
- **백엔드 자바 27기**: 최근 0.5명/일 → 마감 예상 17명(목표 70 대비 24%) → **마감 내 목표 미달 전망** (모집 7일 미만, 신뢰도 낮음).
- **클라우드 8기**: 최근 2.71명/일 → 마감 예상 93명(목표 60 대비 155%) → **마감 내 목표 달성 전망**.
- **그로스 마케팅 6기**: 최근 4.29명/일 → 마감 예상 162명(목표 142 대비 114%) → **마감 내 목표 달성 전망**.
...
| 백엔드 자바 27기 | 758 | 4 | 1 | None | None | 25.0% | None% | None% |
| 클라우드 8기 | 11630 | 73 | 25 | 0 | 0 | 34.2% | 0.0% | 0.0% |
| 그로스 마케팅 6기 | 36539 | 323 | 89 | 9 | 7 | 27.6% | 7.9% | 12.3% |
...
| 클라우드 8기 | 교육시작 0/정원 30 | 모객중(현재 0.0%, 종료후 확정) | 0.0% (모객중·참고용) |
| 그로스 마케팅 6기 | 교육시작 7/정원 57 | 모객중(현재 12.3%, 종료후 확정) | 7.9% (모객중·참고용) |

**기수 벤치마크**

- **백엔드 자바 26기** vs 백엔드자바 4개기수 평균 — 완료율 34.7% vs 30.2% (+4.5pp) · 교육시작전환 25.3% vs 35.2% (-9.9pp) · 정원달성 104.2% vs 83.3% (+20.9pp)
- **백엔드 자바 27기** vs 백엔드자바 5개기수 평균 — 완료율 25.0% vs 31.1% (-6.1pp) · 교육시작전환 None% vs 33.2% · 정원달성 None% vs 79.1%
- **클라우드 8기** vs 클라우드 3개기수 평균 — 완료율 34.2% vs 26.1% (+8.1pp) · 교육시작전환 0.0% vs 30.5% (-30.5pp) · 정원달성 0.0% vs 85.8% (-85.8pp)
- **그로스 마케팅 6기** vs 그로스마케팅 2개기수 평균 — 완료율 27.6% vs 24.5% (+3.1pp) · 교육시작전환 7.9% vs 43.0% (-35.1pp) · 정원달성 12.3% vs 101.3% (-89.0pp)
...
| 백엔드 자바 27기 | 94만 | 1% | 23만 | 94만 | ₩0 | 0% |
| 클라우드 8기 | 1705만 | 17% | 23만 | 68만 | ₩0 | 0% |
| 그로스 마케팅 6기 | 4042만 | 51% | 13만 | 45만 | 7725만 | 191% |

## 📊 전일 대비 경향성 · 직전 260630 대비 (비판적 분석)

| 캠프 | 지원시작 | 지원완료 | 완료전환율 | 내배카 | 목표달성율 | 심사진행(합/불/예비) |
|---|---|---|---|---|---|---|
| 백엔드 자바 26기 | ±0 | ±0 | ±0pp | ±0pp | ±0pp | 합+5 불+3 예+2 |
| 클라우드 8기 | ▲16 | ▲5 | ▼0.9pp | ▼5.4pp | ▲8.4pp | 합+3 불+1 예+3 |
| 그로스 마케팅 6기 | ▲35 | ▲14 | ▲1.6pp | ▲1.3pp | ▲9.9pp | 합+3 불+4 예+4 |

*Δ = 오늘 − 직전 리포트 · 1일 변동이라 노이즈 가능성 유의*

**백엔드 자바 26기**

1. 신규 지원 0명(정체·감소) — 모집 모멘텀 둔화. 마감 임박 효과 없는지, 매체 소진인지 분리 점검.
2. 심사 진행 10건(합격 +5·불합격 +3·예비 +2) vs 지원완료 +0 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 도달 유지(달성율 137.5%) — 점검 축을 완료 수 → 등록 전환·적합도로 이동.

**클라우드 8기**

1. 신규 지원 +16명인데 완료전환율 -0.9pp 하락 — 유입은 늘었으나 완료로 이어지지 않음. '숫자 증가'에 안심 말고 유입 채널 품질·지원서 이탈 지점을 의심해야 함.
2. 심사 진행 7건(합격 +3·불합격 +1·예비 +3) vs 지원완료 +5 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 달성율 33.3→41.7% (+8.4pp) — 오늘 +5명 페이스면 잔여 35명에 약 7일. 잔여 모집기간과 대조해 '달성 가능 페이스'인지 판단.
4. 내배카 보유율 -5.4pp 변동 — 신규 유입의 연령·신분 세그먼트가 이동했을 가능성. 연령대×합불상태/내배카 교차표로 어느 층이 늘었는지 확인.

**그로스 마케팅 6기**

1. 지원 +35명 · 전환율 +1.6pp 동반 — 양·질 함께 개선. 단, 1일 변동이라 추세 확정 전 2~3일 더 관찰 필요.
2. 심사 진행 11건(합격 +3·불합격 +4·예비 +4) vs 지원완료 +14 — 완료수 증가가 '신규 완료'인지 '심사 결과 반영'인지 구분해야 전환율 해석이 정확.
3. 목표 달성율 52.8→62.7% (+9.9pp) — 오늘 +14명 페이스면 잔여 53명에 약 4일. 잔여 모집기간과 대조해 '달성 가능 페이스'인지 판단.
...
**백엔드 자바 27기** (목표 70 · 달성율 1.4%)

1. 목표 달성율 1.4%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 1.0명 기준 잔여 69명은 약 69일 소요. 마감 D-32 내 달성 불가 페이스 — 강한 가속/연장 검토.
2. 완료전환 25.0% vs 미완료 75% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 남성 75% 편중 — 유입 채널·크리에이티브가 특정 성별에 쏠렸는지, 의도된 타깃 설계인지 점검.

**클라우드 8기** (목표 60 · 달성율 41.7%)

1. 목표 달성율 41.7%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 2.7명 기준 잔여 35명은 약 13일 소요. 마감 D-25 대비 여유.
2. 완료전환 34.2% vs 미완료 64% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 대학(원)생 내배카 보유율 25.0%(n=4) — 비용 민감 세그먼트. 이 그룹이 완료전환에서 더 이탈하는지 교차 점검하고 자비·국비 메시지 분기 검토.

**그로스 마케팅 6기** (목표 142 · 달성율 62.7%)

1. 목표 달성율 62.7%를 절대값으로 판단하지 말 것 — 최근 7일 일평균 완료 4.3명 기준 잔여 53명은 약 12일 소요. 마감 D-17로 빠듯 — 가속 필요.
2. 완료전환 27.6% vs 미완료 72% — '지원시작' 분모에 유령·중복·단순열람이 섞였는지, 아니면 지원서 문항·자격요건이 이탈 병목인지 분해해야 실제 전환율이 드러남.
3. 대학(원)생 내배카 보유율 32.0%(n=25) — 비용 민감 세그먼트. 이 그룹이 완료전환에서 더 이탈하는지 교차 점검하고 자비·국비 메시지 분기 검토.
...
|---|---|---|---|---|---|---|---|
| ~19 | 0 | 3 | 0 | 0 | 0 | 0 | 3 |
| 20-24 | 0 | 14 | 1 | 2 | 1 | 1 | 19 |
| 25-29 | 2 | 23 | 5 | 6 | 0 | 1 | 37 |
| 30-34 | 1 | 4 | 0 | 3 | 0 | 0 | 8 |
| 40+ | 0 | 3 | 3 | 1 | 0 | 0 | 7 |
...
|---|---|---|---|---|---|---|---|
| ~19 | 0 | 6 | 0 | 0 | 0 | 0 | 6 |
| 20-24 | 5 | 104 | 12 | 13 | 4 | 6 | 144 |
| 25-29 | 6 | 83 | 8 | 15 | 7 | 0 | 119 |
| 30-34 | 3 | 31 | 9 | 1 | 3 | 0 | 47 |
| 35-39 | 0 | 4 | 0 | 1 | 0 | 0 | 5 |
| 40+ | 0 | 4 | 1 | 0 | 1 | 0 | 6 |
...
| 백엔드 자바 27기 | 30.5 | 28.5 | 27.25 | 31.75 | 19.0 | 34.0 | 4 |
| 클라우드 8기 | 26.0 | 27.1 | 23.0 | 28.0 | 16.0 | 58.0 | 50 |
| 그로스 마케팅 6기 | 25.0 | 25.9 | 23.0 | 28.0 | 18.0 | 60.0 | 246 |
...
def load_status_table(folder):
    ...
    for i in range(hdr_i+1, len(raw)):
        ...
        out[(str(school).strip(), int(gisu))] = {
            ...
            'capacity': cv(r,'수강정원'), 'target': cv(r,'목표모객'),
            'views': cv(r,'조회수'), 'start': cv(r,'지원시작수'),
            'complete': cv(r,'지원완료수'), 'gov24': cv(r,'고용24등록수'),
            'edustart': cv(r,'교육시작수'), 'nbcyes': cv(r,'내배카Yes'),
            'budget': cv(r,'집행예산'), 'budget_rate': cv(r,'예산소진율'),
            'cpa': cv(r,'CPA'), 'cac': cv(r,'CAC'), 'roas': cv(r,'ROAS'),
        ...
        for j, cell in enumerate(cells):
            ...
            if lab in ann_labels and ann_labels[lab] not in annual:
                for k in range(j+1, len(cells)):
                    v = _statnum(cells[k])
                    if v is not None: annual[ann_labels[lab]] = v; break
...
---
*생성 2026-07-02 12:53 · 내배카 비율은 yes/no 유효응답(지원완료·지원중) 기준 · 상태1 공란은 '알 수 없음' 처리*
